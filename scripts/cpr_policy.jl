...
joinpath(CIMPC_path, "../examples/A1-imitation/results/dog_cpr/run10/dog_cpr.jld2"), 
...
p_cpr = ci_mpc_policy(ref_traj, s, obj,
    H_mpc = H_mpc,
    N_sample = N_sample,
    κ_mpc = κ_mpc,
    mode = :configuration,
...
output = EmbeddedLciMpc.exec_policy(p_cpr, [q1_sim0; v1_sim; zeros(12)], 0.0)

println("Finish Loading Dog CPR")
