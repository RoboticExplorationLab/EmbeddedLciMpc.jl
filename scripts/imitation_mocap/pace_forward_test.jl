...
ref_traj = deepcopy(get_trajectory(s.model, s.env,
    ...
    joinpath(CIMPC_path, "../examples/A1-imitation/results/pace_forward/run43/pace_forward_tol0.001.jld2"),
...
# v_target = [1/ref_traj.h * [0;v0;0; 0;0;0; 0;v0;0; 0;v0;0; 0;v0;0; 0;v0;0] for t = 1:H_mpc],)
# obj = TrackingVelocityObjective(model, env, H_mpc,
#     v = h/H_mpc * [Diagonal([[500,150,15]; [6000,6000,800]; 2e-1 * fill([0.7,0.7,1], 4)...]) for t = 1:H_mpc],
